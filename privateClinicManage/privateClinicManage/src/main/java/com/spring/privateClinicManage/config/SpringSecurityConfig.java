...
public class SpringSecurityConfig {
	...
	private ClientRegistration githubClientRegistration() {
		String githubClientId = env.getProperty("GITHUB_CLIENT_ID");
		String githubClientSecret = env.getProperty("GITHUB_KEY");
	...
	private ClientRegistration googleClientRegistration() {
		String googleClientId = env.getProperty("GOOGLE_CLIENT_ID");
		String googleClientSecret = env.getProperty("GOOGLE_KEY");

...
import com.spring.privateClinicManage.service.OpenRouterService;
...
public class CozeController {
    ...
    public Object streamChat(@RequestParam Map<String, String> params,
        ...
        try {
            ...
            String openRouterAPI = env.getProperty("OPENROUTER");
            ...
            OpenRouterService client = new OpenRouterService(openRouterAPI);
            String prompt = params.get("prompt") + "\n\n" + "Trả lời thật ngắn gọn !"; 
            String openRouterResponse = client.generateText(prompt);
            String json = gson.toJson(openRouterResponse);
            try {
